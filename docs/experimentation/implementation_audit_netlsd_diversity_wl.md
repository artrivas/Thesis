...
> **Historical record.** Paths in this document describe the repository layout as
> it was when the document was written, before the reorganization of 2026-09-08.
> `docs/`, `tests/`, `scripts/` and `results/` now sit at the repo root, and the
> `outputs/` trees referenced here are archived under `archive/legacy-outputs/`. See
> [`../../README.md`](../../README.md).
...
- `docs/experimentation/theory.md`
- `docs/experimentation/experimental_protocol.md`
- `docs/experimentation/final_experimentation_plan.md`
- `docs/experimentation/implementation_audit.md`
- `docs/experimentation/implementation_log.md`
- `docs/experimentation/results_schema.md`

No PDFs are present under `docs`. To compare against original papers while
...
- `tests/test_experimentation_baseline.py`
...
According to `docs/experimentation/theory.md`,
...
According to `docs/experimentation/theory.md` and the local
...
Extended `tests/test_workflows.py` with focused validation tests:

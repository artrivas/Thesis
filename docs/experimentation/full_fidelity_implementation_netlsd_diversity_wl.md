...
Documentation inspected in `docs`:

- `docs/experimentation/implementation_audit_netlsd_diversity_wl.md`
...
Local papers also used because no PDFs are stored under `docs`:
